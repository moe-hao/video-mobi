...
export default function PaymentTab({ feedbackAddReq, onChange }: { feedbackAddReq: FeedbackAddReq; onChange: (req: FeedbackAddReq) => void }) {
  return (
    <div className="flex w-full flex-col gap-4">
      ...
      <div className="flex flex-col gap-1 w-full mb-4">
        <Label isRequired htmlFor="input-type-transaction-id">Transaction ID</Label>
