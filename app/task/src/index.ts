...
import { scheduleAdReportDaily, scheduleAdReportWeek, scheduleAdReportYesterday, scheduleSubscriptionRenewalReport, scheduleTtvReport } from './schedules/report';
...
const tasks = [
    ...
    schedule.scheduleJob('0 7 * * *', async () => { await scheduleTtvReport() }),
